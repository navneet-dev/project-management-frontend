    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            <header className="relative bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-700 text-white">
                <div className="container mx-auto px-6 py-24 md:py-32 text-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto mb-8">
                        A modern task and project management app built with
                        Laravel, React, and MySQL. Stay productive, stay
                    ...
                    <div className="grid gap-10 md:grid-cols-3">
                        <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition transform hover:-translate-y-1">
                            ...
                            <p className="text-gray-600">
                                Create, update, and track your tasks in a clean,
                                intuitive interface.
                            </p>
                        </div>
                        <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition transform hover:-translate-y-1">
                            ...
                            <p className="text-gray-600">
                                Group tasks into projects and keep everything
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition transform hover:-translate-y-1">
                            ...
                            <p className="text-gray-600">
                                Stay focused with priorities, deadlines, and
                                progress tracking.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-indigo-700 text-white text-center">
                <div className="container mx-auto px-6">
                    ...
                    <p className="mb-8 text-lg text-indigo-200">
                        Sign up for free and experience a smarter way to
            ...
            <footer className="bg-gray-900 text-gray-400 py-8 mt-auto">
                <div className="container mx-auto px-6 text-center">
                    <p className="text-sm">
                        © {new Date().getFullYear()} Task & Project Manager. All
                        rights reserved.
                    </p>
                </div>
            </footer>
